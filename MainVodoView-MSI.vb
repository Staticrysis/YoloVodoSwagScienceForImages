Public Class MainVodoView
    ...
    Dim fd As New OpenFileDialog With {.InitialDirectory = "D:\Pictures\Wallpapers"}
    ...
    Private Async Sub ConvertImage(sender As Object, e As EventArgs) Handles ConvertToolStripButton.Click
        Dim InhNode = CType(Root_ITV.SelectedNode, InhancedTreeNode)
        Dim stats = Await Task.Run(Function()
                                       Return ImageStatsAsync(InhNode.OriginalImage, InhNode.CancelConversion, Integer.Parse(Contrast_ToolStripTextBox.Text)).Result
                                   End Function)
    ...
    Private Sub Root_ITV_AfterSelect(sender As InhancedTreeView, e As TreeViewEventArgs) Handles Root_ITV.AfterSelect
